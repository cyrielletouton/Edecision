...
VALUES
  ...
  ('Problematique 2','Commentaire 2','Terminé', true, 1, 10, 10, '2022-11-10'),
  ('Problematique 3','Commentaire 3','Terminé', false, 1, 5, 5, '2022-10-03'),
  ('Problematique 4','Commentaire 4','Ouvert', false, 1, 0, 0, '2022-11-16'),
  ('Problematique 5','Commentaire 5','En cours', false, 1, 10, 1, '2022-11-16'),
  ('Problematique 6','Commentaire 6','Terminé', true, 1, 10, 10, '2022-09-18');
